...
const ProductSchema = new mongoose.Schema({
  ...
  //   trim: true,
  // },
  brand: { type: mongoose.Schema.Types.ObjectId, ref: "Brand", required: true }, // store subcategory
 ...
 category: { type: mongoose.Schema.Types.ObjectId, ref: "Category", required: true }, // store subcategory
